...
namespace Unity.VRTemplate
{
    ...
    public class CustomBooleanToggleVisualsController : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        const float k_TargetPositionX = 50f;
